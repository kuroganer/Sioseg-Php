...
$userName = $userName ?? 'Admin'; // Nome do usuário logado.
                            ...
                            <?php foreach ($os_a_fazer as $os): ?>
                                <div class="kanban-task" id="os-<?= htmlspecialchars($os->id_os) ?>" draggable="true">
                                    ...
                                    <div class="task-actions">
                                        <a href="<?= BASE_URL ?>admin/os/edit/<?= $os->id_os ?>" class="task-action-btn view-btn" title="Ver/Editar OS">
...
<script>
    ...
    function carregarOsPendentes() {
        ...
        fetch(BASE_URL + 'admin/dashboard/os-pendentes')
                        ...
                        html += `
                            <div style="border:1px solid #ddd;padding:15px;margin-bottom:15px;border-radius:6px;background:#f8f9fa;">
                                <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
                                    ...
                                    <a href="${BASE_URL}admin/os/edit/${os.id_os}" style="color:#007bff;text-decoration:none;font-size:12px;padding:4px 8px;border:1px solid #007bff;border-radius:4px;">Ver OS →</a>
                                </div>
