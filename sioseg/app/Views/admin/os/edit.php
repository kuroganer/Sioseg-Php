<div class="form-container">
    ...
    <div class="form-main">
        <form action="<?= BASE_URL ?>admin/os/update/<?= $os->id_os ?>" method="POST" id="os-edit-form">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="cliente_input" list="clientes_list" placeholder="Digite nome ou CPF/CNPJ..." onchange="setClienteId(this.value)" value="<?php foreach ($clientes as $cliente) { if ($cliente->id_cli == $os->id_cli_fk) { $nomeCliente = $cliente->tipo_pessoa === 'juridica' ? $cliente->razao_social : $cliente->nome_cli; $documento = $cliente->tipo_pessoa === 'juridica' ? $cliente->cnpj : $cliente->cpf_cli; $documento = !empty($documento) ? $documento : 'Sem documento'; echo htmlspecialchars($nomeCliente . ' - ' . $documento); break; } } ?>" required>
                            <input type="hidden" id="id_cli_fk" name="id_cli_fk" value="<?= $os->id_cli_fk ?>" required>
                            <datalist id="clientes_list">
                                <?php foreach ($clientes as $cliente): $nomeCliente = $cliente->tipo_pessoa === 'juridica' ? $cliente->razao_social : $cliente->nome_cli; $documento = $cliente->tipo_pessoa === 'juridica' ? $cliente->cnpj : $cliente->cpf_cli; $documento = !empty($documento) ? $documento : 'Sem documento'; $displayText = $nomeCliente . ' - ' . $documento; ?>
                            ...
                            <?php foreach ($materiais as $material): ?>
                                <div class="material-item-existing">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group">
                                            <label>&nbsp;</label>
                                            <!-- Alterado para um botão que usa JavaScript para submeter um formulário dinâmico -->
                        <button type="button" class="btn-remove-material-existing"
                            data-url="<?= BASE_URL ?>admin/os/remove-material/<?= $os->id_os ?>/<?= $material->id_prod ?>"
