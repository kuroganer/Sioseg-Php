                ...
                <?php foreach ($osList as $os): ?>
                    <tr>
                        ...
                        <div class="actions-wrapper">
                            <!-- Botão Editar -->
                            <a href="<?= BASE_URL ?>funcionario/os/edit/<?= $os->id_os ?>" class="action-button edit-button">Editar</a>
                            ...
                            <?php if (!in_array($os->status, ['concluida', 'encerrada'])): ?>
                                <form action="<?= BASE_URL ?>funcionario/os/changeStatus" method="post" class="status-form">
