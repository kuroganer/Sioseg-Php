                    ...
                    <tr class="client-row<?= ($cliente->status ?? '') === 'inativo' ? ' status-inativo' : '' ?>" data-type="<?= htmlspecialchars($cliente->tipo_pessoa ?? '') ?>">
                        ...
                        <td class="action-cell">
                            <div class="actions-wrapper">
                                <!-- Link para edição -->
                                <a href="<?= BASE_URL ?>funcionario/clientes/edit/<?= $cliente->id_cli ?>" class="action-button edit-button">Editar</a>

                                <!-- Formulário para alterar status -->
                                <form action="<?= BASE_URL ?>funcionario/clientes/changeStatus" method="post" class="status-form">
