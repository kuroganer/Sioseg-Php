document.addEventListener('DOMContentLoaded', function () {
    ...
    function initializeFormScripts() {
        applyMask(document.getElementById('cpf_usu'), maskCpf);
        applyMask(document.getElementById('tel1_usu'), maskPhone);
        applyMask(document.getElementById('tel2_usu'), maskPhone);
        applyMask(document.getElementById('tel3_usu'), maskPhone);
        applyMask(document.getElementById('rg_usu'), maskRg);

        var cpfInput = document.getElementById('cpf_usu');
        var emailInput = document.getElementById('email_usu');
        var tel1Input = document.getElementById('tel1_usu');
        var tel2Input = document.getElementById('tel2_usu');
        var senhaInput = document.getElementById('senha_hash_usu');
        ...
        if (tel1Input) {
            tel1Input.addEventListener('blur', function() {
        ...
        if (tel2Input) {
            tel2Input.addEventListener('blur', function() {
                if (this.value && !validatePhone(this.value)) {
                    showFieldError(this, 'Telefone deve ter 10 ou 11 dígitos');
                } else {
                    clearFieldError(this);
    ...
    if (form) {
        form.addEventListener('submit', function(e) {
            ...
            var cpfField = document.getElementById('cpf_usu');
            var tel1Field = document.getElementById('tel1_usu');
            var tel2Field = document.getElementById('tel2_usu');
            var tel3Field = document.getElementById('tel3_usu');
            var rgField = document.getElementById('rg_usu');
            ...
            if (tel3Field && tel3Field.value) tel3Field.value = removePhoneMask(tel3Field.value);
    ...
    function checkDuplicate(value, type, callback) {
        ...
        const endpoint = window.BASE_URL + 'admin/users/verificar-' + type;
    ...
    const emailField = document.getElementById('email_usu');
    if (emailField) {
    ...
    // CPF duplicate check
    const cpfField = document.getElementById('cpf_usu');
    if (cpfField) {
